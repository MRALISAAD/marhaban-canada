...
const copy = {
  fr: {
    ...
    description: 'Message recu ou description de la situation',
    descriptionPlaceholder: "Decrivez ce qui s'est passe, le message recu, la demande faite.",
    consent: "Je comprends que Marhaban Canada offre une evaluation informative du risque, pas un conseil juridique ou d'immigration reglemente.",
    submit: 'Envoyer la demande',
    successTitle: 'Demande envoyee.',
    successText: "Nous allons l'examiner de maniere informative et prudente.",
    successNote: 'Nous vous repondrons par email avec des observations et ressources officielles.',
    close: 'Fermer',
  },
  en: {
    eyebrow: 'Report',
