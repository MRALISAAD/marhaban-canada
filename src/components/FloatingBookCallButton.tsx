...
export function FloatingBookCallButton() {
  ...
  // On the booking form page the form is the CTA — hide this button entirely
  const isHidden = pathname?.includes('/reserver/formulaire') ?? false;
  ...
  // Return null after all hooks on the form page
  if (isHidden) return null;

  return (
    <div
      className={`fixed inset-x-3 bottom-3 z-40 max-w-[calc(100vw-1.5rem)] transition duration-200 sm:inset-x-6 md:inset-x-auto md:bottom-6 md:max-w-none lg:hidden ${
