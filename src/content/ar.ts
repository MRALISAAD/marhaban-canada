...
export const arContent: LocaleContent = {
  ...
  serviceAccompagnementDisclaimer: "يقدم هذا الموقع خدمة دعم وتوجيه. وهو لا يحل محل الخدمات الحكومية الرسمية.",
  ...
  resources: {
    ...
    accompaniment: {
      shortDefinition: "يقدم هذا الموقع خدمة دعم وتوجيه. وهو لا يحل محل الخدمات الحكومية الرسمية.",
    ...
    quickGuides: {
      documentsCard: {
        ...
        ctaLabel: "عرض قائمة تحقق الوثائق",
        href: "/checklist",
      },
      transportCard: {
        title: "النقل والتصاريح",
    ...
    sections: {
      ...
      documents: { title: "الوثائق", hint: "لتجهيز أوراقك مرة واحدة، وتوفير الوقت." },
      transport: { title: "النقل", hint: "لفهم التصاريح والنقل حسب مقاطعتك." },
  ...
  resourcesPage: {
    labels: {
      ...
      title: "الموارد الرسمية والمجتمعية",
      subtitle: "روابط موثوقة، مصنفة حسب الحاجة.",
      searchPlaceholder: "بحث (هجرة، صحة، توظيف...)",
      provinceLabel: "المقاطعة",
      categoryLabel: "الفئة",
      filterAll: "الكل",
      officialLabel: "رسمي",
    ...
    categories: [
      { id: "arrival", title: "الوصول", description: "الحالة، الإجراءات، والاستقرار." },
      ...
      { id: "documents", title: "الوثائق", description: "الأوراق الأساسية والنسخ." },
      { id: "transport", title: "النقل", description: "التصاريح وبطاقات النقل." },
    ...
    items: {
      ...
      ircc: { title: "IRCC - الهجرة", description: "البوابة الرسمية للهجرة." },
      ...
      "documents-guide": { title: "دليل الوثائق", description: "قائمة تحقق الوثائق المطلوب تجهيزها." },
      "transport-guide": { title: "دليل النقل", description: "التصاريح + الإجراءات حسب المقاطعة." },
      "credit-guide": { title: "دليل الائتمان", description: "النتيجة وبداية نظيفة." },
      driving: { title: "رخصة القيادة", description: "معلومات كندا الرسمية." },
      saaq: { title: "SAAQ (كيبيك)", description: "التصاريح والمركبات في كيبيك." },
      "service-ontario-driving": { title: "ServiceOntario - التصاريح", description: "التصاريح والطرق في أونتاريو." },
      icbc: { title: "ICBC (كولومبيا البريطانية)", description: "التصاريح والتأمين في كولومبيا البريطانية." },
      "alberta-registries": { title: "سجلات ألبرتا", description: "التصاريح والخدمات في ألبرتا." },
    ...
    guides: {
      documents: {
        ...
        what: "تستخدم الوثائق الأساسية لجميع الإجراءات (التوظيف، الصحة، السكن).",
        why: ["تجنب العوائق الإدارية", "توفير الوقت", "حماية أصولك"],
        how: ["مسح جواز السفر والتصاريح", "إنشاء مجلد رقمي", "طباعة نسخ رئيسية", "تخزين نسخة دون اتصال"],
        pitfalls: ["مشاركة وثائقك دون تحقق", "فقدان الأصول", "عدم الاحتفاظ بنسخ احتياطية"],
        actions: ["إعداد قائمة تحقق شخصية", "إنشاء مجلد سحابي آمن"],
        ctaLabel: "قائمة تحقق الوثائق المطلوب تجهيزها",
        ctaHref: "/checklist",
        sources: [{ name: "IRCC", url: "https://www.canada.ca/fr/immigration-refugies-citoyennete.html" }],
      },
      transport: {
        ...
        callout: "تصريح صالح = حرية + أمان.",
        what: "تختلف التصاريح وبطاقات النقل حسب المقاطعة.",
  ...
  footer: {
    disclaimer: "خدمة معلومات ومرافقة. لا تحل محل الخدمات الحكومية. يجب دائماً التحقق من الإجراءات الرسمية على المواقع الحكومية.",
  ...
  shared: {
    ...
    disclaimer: "للمعلومات والتوجيه فقط. ارجع دائمًا إلى المواقع الرسمية.",
  ...
  howToUsePage: {
    ...
    whatThisSiteDoesNotDo: {
      ...
      items: [
        "لا يحل محل خدمات محامٍ أو مستشار هجرة.",
