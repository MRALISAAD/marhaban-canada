...
export const steps: Record<string, Step> = {
  nas: {
    ...
    how: [
      'Vérifie les preuves utiles liées à ton profil général.',
    ...
    docs: ['Pièce d’identité', 'Preuve de profil général', 'Adresse et coordonnées (si demandées)'],
    avoid: [
  ...
  phone: {
    ...
    phase: 'Semaine 1',
    summary: 'Utile pour le travail, la banque et les démarches du quotidien.',
    motto: 'Commence flexible. Évite les contrats longs.',
    cta: {
      label: 'Comparer les forfaits près de moi',
      href: 'https://crtc.gc.ca/fra/phone/mobile.htm',
    },
    what:
      'Un numéro canadien facilite les démarches. Il sert pour les appels, les SMS et la vérification de comptes.',
    why: ['Être joignable rapidement', 'Valider des comptes officiels', 'Recevoir des appels liés au travail'],
    how: [
      'Compare 2 à 3 offres (prix, données, appels)',
    ...
    avoid: [
      'Signer un contrat de 24 mois trop tôt',
      'Prendre un téléphone « gratuit » avec un forfait cher',
      'Accepter des frais d’activation sans les comprendre',
      'Ignorer les limites de données et les frais de dépassement',
      'Activer l’itinérance (roaming) sans en avoir besoin',
    ],
    smartTips: [
      'Commence simple, ajuste après 2–3 semaines',
      'Demande le coût total mensuel, taxes incluses',
      'Teste la couverture là où tu vis et travailles',
      'Vérifie si la résiliation est gratuite',
      'La portabilité du numéro est souvent possible plus tard',
    ],
  },
  ...
  bank: {
    ...
    cta: {
      label: 'Comparer les offres pour nouveaux arrivants',
    ...
    what:
      'Un compte bancaire sert à recevoir ton salaire et à payer tes dépenses. La carte de débit est utilisée au quotidien. La carte de crédit permet de construire ton historique de crédit.',
    why: ['Recevoir ton salaire', 'Payer ton loyer et tes factures', 'Construire ton crédit en toute sécurité'],
    how: [
      'Compare les offres pour nouveaux arrivants',
      'Choisis une banque proche ou pratique (application + succursale)',
      'Prends rendez-vous si possible',
      'Apporte ta pièce d’identité et ta preuve de profil général',
      'Ouvre un compte courant avec carte de débit',
      'Si nécessaire, demande une petite carte de crédit',
      'Paie à temps et utilise-la avec modération',
    ],
    docs: ['Pièce d’identité', 'Preuve de profil général', 'Adresse locale (si demandée)'],
    avoid: [
      'Forfaits avec frais cachés',
      'Assurances inutiles vendues au comptoir',
      'Limites de crédit trop élevées dès le début',
    ...
    smartTips: [
      ...
      'Essaie d’obtenir 0 $ de frais mensuels au départ',
      'Commence avec une petite limite de crédit',
      'Paie ta carte à temps, chaque mois',
      'Garde l’utilisation sous 30 % si possible',
    ],
  },
  ...
  license: {
    ...
    phase: 'Mois 1',
    summary: 'Vérifier si ton document de conduite est reconnu et comprendre les étapes locales.',
    ...
    what:
      'Les règles de conduite dépendent de ta province. Les étapes et les examens varient selon ton pays d’origine.',
    why: ['Conduire légalement.', 'Éviter des amendes.', 'Garder une assurance valide.'],
    how: [
      'Vérifie la durée autorisée avec ton document de conduite actuel.',
      ...
      'Récupère ton document local et garde tes preuves.',
    ],
    docs: ['Document de conduite actuel', "Pièce d’identité", 'Preuve de profil général', 'Dossier de conduite (si requis)'],
    avoid: [
    ...
    smartTips: [
      ...
      'Vérifie les règles d’assurance liées à la conduite.',
    ],
  },
  ...
  health: {
    ...
    how: [
      'Vérifie les conditions d’accès selon ta province.',
      'Rassemble tes documents pratiques d’installation (profil général + adresse).',
    ...
    docs: ["Pièce d’identité", 'Preuve de profil général', "Preuve d’adresse locale"],
    avoid: [
  ...
  integration: {
    ...
    docs: ["Pièce d’identité", 'Preuve de profil général', 'Coordonnées de contact'],
    avoid: [
