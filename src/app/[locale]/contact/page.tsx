  ...
  const bookingTexts = {
    fr: {
      ...
      offers: [
        {
          ...
          description: 'Un premier échange pour comprendre ton besoin et clarifier si l’orientation pratique est adaptée.',
        },
        {
          name: 'Appel orientation',
          duration: '30 min',
          price: '29 $',
          description: 'Un appel ciblé pour prioriser tes étapes pratiques, tes questions générales et les ressources à vérifier.',
        },
        {
          name: 'Pack accompagnement',
          duration: '60 min + résumé écrit',
          price: '69 $ à 99 $',
          description: 'Une orientation plus complète avec priorités claires, erreurs à éviter et résumé après l’appel.',
        },
      ],
      ...
      form: {
        ...
        formOfferOptions: [
          { value: 'discovery', label: 'Appel découverte — 15 min — gratuit au lancement' },
          { value: 'orientation', label: 'Appel orientation — 30 min — 29 $' },
          { value: 'support', label: 'Pack accompagnement — 60 min + résumé écrit — 69 $ à 99 $' },
        ],
        formMessage: 'Message',
    ...
    en: {
      ...
      offers: [
        {
          ...
          description: 'A first conversation to understand your need and clarify whether practical orientation is a good fit.',
        },
        {
          name: 'Orientation call',
          duration: '30 min',
          price: '$29',
          description: 'A focused call to prioritize your practical steps, general questions, and resources to verify.',
        },
        {
          name: 'Support pack',
          duration: '60 min + written summary',
          price: '$69 to $99',
          description: 'More complete orientation with clear priorities, mistakes to avoid, and a summary after the call.',
        },
      ],
      ...
      form: {
        ...
        formOfferOptions: [
          { value: 'discovery', label: 'Discovery call — 15 min — free at launch' },
          { value: 'orientation', label: 'Orientation call — 30 min — $29' },
          { value: 'support', label: 'Support pack — 60 min + written summary — $69 to $99' },
        ],
        formMessage: 'Message',
    ...
    ar: {
      ...
      offersTitle: 'عروض واضحة',
      offersIntro: 'صيغ بسيطة لتوضيح وضعك العام بدون وعد بنتيجة مضمونة.',
      offers: [
        {
          name: 'مكالمة تعارف',
          duration: '15 دقيقة',
          price: 'مجانية عند الإطلاق',
          description: 'محادثة أولى لفهم حاجتك وتوضيح هل التوجيه العملي مناسب لك.',
        },
        {
          name: 'مكالمة توجيه',
          duration: '30 دقيقة',
          price: '29 $',
          description: 'مكالمة مركزة لترتيب خطواتك العملية وأسئلتك العامة والموارد التي يجب التحقق منها.',
        },
        {
          name: 'حزمة مرافقة',
          duration: '60 دقيقة + ملخص مكتوب',
          price: '69 $ إلى 99 $',
          description: 'توجيه أوسع مع أولويات واضحة وأخطاء يجب تجنبها وملخص بعد المكالمة.',
        },
      ],
      ...
      form: {
        ...
        formOfferOptions: [
          { value: 'discovery', label: 'مكالمة تعارف — 15 دقيقة — مجانية عند الإطلاق' },
          { value: 'orientation', label: 'مكالمة توجيه — 30 دقيقة — 29 $' },
          { value: 'support', label: 'حزمة مرافقة — 60 دقيقة + ملخص مكتوب — 69 $ إلى 99 $' },
        ],
        formMessage: 'الرسالة',
